...
SYSTEM_ID = "spreek2schrijf"
#System name, the way the system is presented to the world
SYSTEM_NAME = "Spreek2Schrijf"
...
#
# COMMAND = WEBSERVICEDIR + "/spreek2schrijf_wrapper.sh $DATAFILE $STATUSFILE $OUTPUTDIRECTORY"
#Or for the shell variant:
SCRATCHDIRECTORY=ROOT+'/scratch/'

COMMAND = WEBSERVICEDIR + "/spreek2schrijf_wrapper.sh $STATUSFILE $INPUTDIRECTORY $OUTPUTDIRECTORY "+SCRATCHDIRECTORY+" "+WEBSERVICEDIR+" $PARAMETERS"
